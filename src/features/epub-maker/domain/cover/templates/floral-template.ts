...
export class FloralTemplateRenderer implements CoverBackgroundRenderer {
  readonly id = FLORAL_BACKGROUND_ID;

  resolveAdaptiveTextSeed() {
    return {
      startColor: floralTemplateTheme.gradientStart,
      endColor: floralTemplateTheme.gradientEnd,
    };
  }
  ...
  renderSvgBackground({ metrics, width, height }: CoverBackgroundSvgContext): string {
    return renderFramedGradientBackgroundSvg({
      ...
      height,
      metrics,
      gradientStart: floralTemplateTheme.gradientStart,
      gradientEnd: floralTemplateTheme.gradientEnd,
      frameStroke: floralTemplateTheme.frameStroke,
  ...
  private drawCanvasDecoration(
    ...
    context.strokeStyle = floralTemplateTheme.accentColor;
    ...
    context.fillStyle = floralTemplateTheme.accentColor;
