...
export const APP_SEMANTIC_COLOR_TOKENS = {
  app: {
    ...
    fg: {
      ...
      link: semanticColor("{colors.teal.700}", "{colors.teal.400}"),
      linkHover: semanticColor("{colors.teal.800}", "{colors.teal.300}"),
    ...
    syntax: {
      ...
      string: semanticColor("{colors.green.700}", "{colors.green.400}"),
